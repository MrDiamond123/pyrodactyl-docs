...
<Callout type="info">
  For Pyrodactyl-specific issues, please use [Pyrodactyl GitHub Discussions](https://github.com/pyrohost/pyrodactyl/discussions) or
...
<Cards>
  <Card title="Installation Guide" href="/docs/installation/fresh-installation">
  ...
  <Card
    title="Configuration"
    href="/docs/installation/fresh-installation#panel-configuration"
  >
    Learn how to configure your Pyrodactyl instance
  </Card>
  <Card
    title="Wings Setup"
    href="/docs/installation/fresh-installation#wings-installation"
  >
